...
public class ListEtudiantsActivity extends AppCompatActivity implements EtudiantAdapter.OnItemClickListener {
    ...
    // Update these URLs
    private String fetchUrl = "http://192.168.100.38/projet/ws/loadEtudiant.php";
    private String updateUrl = "http://192.168.100.38/projet/ws/updateEtudiant.php";
    private String deleteUrl = "http://192.168.100.38/projet/ws/deleteEtudiant.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(ListEtudiantsActivity.this, AddEtudiant.class);
                    startActivity(intent);
                } catch (Exception e) {
                    Log.e(TAG, "Error starting AddEtudiant activity", e);
                    Toast.makeText(ListEtudiantsActivity.this,
    ...
    private void showEditDialog(final Etudiant etudiant) {
        ...
        if (etudiant.getDateNaissance() != null && !etudiant.getDateNaissance().isEmpty()) {
            ...
            try {
                ...
                Date date = inputFormat.parse(etudiant.getDateNaissance());
                ...
                dateNaissanceTextView.setText(etudiant.getDateNaissance());
            }
